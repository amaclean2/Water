...
const createStatements = [
  ...
  `CREATE TABLE ski( id INT AUTO_INCREMENT, avg_angle FLOAT, max_angle FLOAT, approach_distance VARCHAR(50), aspect VARCHAR(3), summit_elevation INT, base_elevation INT, exposure INT, gear VARCHAR(50), season VARCHAR(100), trail_path TEXT, PRIMARY KEY(id) );`,
