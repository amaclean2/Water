...
const getCompletedAdventureByUserStatement =
  'SELECT a.adventure_name, a.adventure_type, a.nearest_city, a.id AS adventure_id FROM completed_adventures AS ac INNER JOIN users AS u ON ac.creator_id = u.id INNER JOIN adventures AS a ON ac.adventure_id = a.id WHERE ac.creator_id = ?'
