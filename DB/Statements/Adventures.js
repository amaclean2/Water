...
const createNewBikeAdventureStatement =
  'INSERT INTO adventures (adventure_bike_id, adventure_name, adventure_type, bio, coordinates_lat, coordinates_lng, creator_id, nearest_city, public, rating) VALUES ?'
const createNewSkiStatement =
  'INSERT INTO ski (avg_angle, max_angle, approach_distance, aspect, difficulty, summit_elevation, base_elevation, exposure, gear, season, trail_path) VALUES ?'
...
const updateAdventureStatements = {
  ...
  bike_difficulty:
    'UPDATE bike AS b INNER JOIN adventures AS a ON a.adventure_bike_id = b.id SET b.difficulty = ? WHERE a.id = ?',
